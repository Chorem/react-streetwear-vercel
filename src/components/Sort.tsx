...
import { ESortProperty, Sort as TSort } from "../redux/filter/types";
...
export const sortType: SortItem[] = [
  { name: "popularity (DESC)", sortProperty: ESortProperty.RATING_DESC },
  { name: "popularity (ASC)", sortProperty: ESortProperty.RATING_ASC },
